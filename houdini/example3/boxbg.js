registerPaint('boxbg', class {
  ...
  static get inputProperties() { return ['--boxColor', '--widthSubtractor', 'height']; }
  ...
  paint(ctx, size, props) {
    ...
    console.dir(props.get('--boxColor'));
    console.dir(props.get('--widthSubtractor'));
    console.dir(props.get('height'));
